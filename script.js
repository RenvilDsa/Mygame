//Age in days
function ageInDays(){
var birthYear = prompt("Enter your year when you were born?");
...
humanDiv.innerHTML = "<img src='" + imageDatabase[humanImageChoice] + "'width=150 style='box-shadow:00px 10px 50px rgba(37,58,233,1);'>"
messageDiv.innerHTML = "<h1 style='color:" + finalMessage['color'] + "; font-size:60px;padding:30px;'>" + finalMessage['message'] + "</h1>"   
botDiv.innerHTML = "<img src='" + imageDatabase[botImageChoice] + "'width=150 style='box-shadow:00px 10px 50px rgba(243,38,24,1);'>"
document.getElementById('flex-cat-div').appendChild(humanDiv);
document.getElementById('flex-cat-div').appendChild(messageDiv);
document.getElementById('flex-cat-div').appendChild(botDiv);
}
